    ...
    <div class="bg-white">
      <UContainer class="py-5 flex gap-6 items-start">
        <div class="backdrop-seller">
          <UAvatar size="3xl" alt="Moreno Store" img-class="object-cover" />
          <span class="text-xl text-white font-medium">Moreno Adryan</span>
        </div>
        <div class="grid grid-cols-2 py-4 gap-4 flex-1">
          ...
          <div class="flex gap-2 items-center">
            ...
            <span>Penilaian:</span>
            <span class="text-primary">4.9 (513 Penilaian)</span>
          </div>
          <div class="flex gap-2 items-center">
            <IconUserCheck />
            <span>Bergabung:</span>
    ...
    <UContainer class="py-8 space-y-8">
      ...
      <div class="grid grid-cols-6 gap-5">
        <BaseProductCard
          ...
          :price="10000"
          image="https://picsum.photos/1080/1080?random=1"
          :slug="`product-${i}`"
          :discount="100"
        />
      </div>
      <div class="flex justify-center mt-8">
        <BasePagination v-model="page" :total="itemspaginations.length" />
      </div>
    </UContainer>
  </div>
</template>
...
const page = ref(1);
const itemspaginations = ref(Array(55));
</script>
